<div class="home_box">
        <div class="content">
          <h2 id="title">Gift Card<span>Please choose a design and add input e-gift information:</span></h2>
        </div>
      </div>
      <div class="groupcontent groupcontent_pages">
        <div class="content e-gift-page">
          <div class="egiftrow" style="margin-bottom: 10px;">
            <div id="ValidationSummary1" style="color:Red;display:none;"></div>
          </div>
          <div id="egifttopnote"></div>
