(function () {
    ...
    var scrollpry = function scrollpry() {
        ...
        $('#subbar ,#promo_bt ').on('click', function () {
    ...
    $(document).ready(function () {
        ...
        var heightTop = $('.site-splash').height();
        scrollpry();
        new WOW().init();
        $('.header-inner').affix({ offset: { top: heightTop } });
        // $('.splash-slider').cycle('command');
